...
| P1 | Historia zmian / audit log | Wdrożone | Trigger bazy zapisuje `task_events`, a Task Detail pokazuje kto utworzył, edytował, zmienił status, anulował albo ponowił polecenie |
